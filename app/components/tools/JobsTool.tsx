        ...
        {isDirty && (
          <div className="flex items-center gap-2">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#FFBF00] text-body-cornsilk text-[13px] font-bold hover:bg-[#4E5AC2] transition-colors disabled:opacity-50"
            >
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-4">
          <div>
            ...
            <input 
              ...
              className={cn(
                "w-full bg-[#161616] border rounded px-3 py-1.5 text-[13px] text-[#FFF8DC] font-mono transition-colors focus:outline-none",
                isValid ? "border-[#2A2A2A] focus:border-[#FFBF00]" : "border-red-500/50 focus:border-red-500"
              )}
            />
            {!isValid && (
              ...
              if (part.endsWith('_spec.md') || part.endsWith('.md')) {
                return (
                  <button
                    ...
                    className="text-[#FFBF00] hover:text-body-cornsilk underline underline-offset-2 font-bold cursor-pointer transition-colors"
                  >
                    {part}
                  </button>
                );
